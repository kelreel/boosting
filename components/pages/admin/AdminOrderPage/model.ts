...
order$
    .on(fetchAdminOrderFx.doneData, (_, order) => order)
    .on(setOrderProgressFx.doneData, (_, data) => data)
    .on(setOrderStatusFx.doneData, (_, data) => data)
    .on(setBoosterFx.doneData, (_, data) => data)
